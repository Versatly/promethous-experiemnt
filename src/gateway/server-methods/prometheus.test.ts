...
describe("prometheus.recursion gateway authorization", () => {
  it("allows operator.read scope", async () => {
    const respond = vi.fn();
    await handleGatewayRequest({
      req: { type: "req", id: "rec-read-1", method: "prometheus.recursion", params: {} },
      client: {
        connect: {
          role: "operator",
          scopes: ["operator.read"],
  ...
  it("rejects calls without read or write scope", async () => {
    const respond = vi.fn();
    await handleGatewayRequest({
      req: { type: "req", id: "rec-read-2", method: "prometheus.recursion", params: {} },
      client: {
        connect: {
          role: "operator",
          scopes: [],
...
describe("prometheus.monolith gateway authorization", () => {
  it("allows operator.read scope", async () => {
    const respond = vi.fn();
    await handleGatewayRequest({
      req: { type: "req", id: "mono-read-1", method: "prometheus.monolith", params: {} },
      client: {
        connect: {
          role: "operator",
          scopes: ["operator.read"],
  ...
  it("rejects calls without read or write scope", async () => {
    const respond = vi.fn();
    await handleGatewayRequest({
      req: { type: "req", id: "mono-read-2", method: "prometheus.monolith", params: {} },
      client: {
        connect: {
          role: "operator",
          scopes: [],
